...
# warmup
348 attractions
data types of character (name of place, admission, setting, region), double (dates)
in 2022 more visited Crown Estate Windsor than any other site
free admission to National Museum Scotland
...
Not available, because some of the raw 2021 data is NA, therfore wihtout some kind of cleansing of the data, performing any calculations is imposisble. 
...
na.rm allows you, via "TRUE" or "FALSE" to specify whether or not rows including NA should be removed for the purpose of calculation. when this is set to TRUE, calculating results becomes posisble. 
...
This suggests that in each category there exists a small number of attractions with very high visitor levels, meaning that the average visitor number is very high on account of the volume recieved by a small number of institutons. However, due to the majority of attractions being smaller, the median is noticably lower, due to more sights having smaller visitor numbers. 
